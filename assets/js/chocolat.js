        ...
        _createClass(Chocolat, [
                ...
                value: function load(index) {
                    ...
                    return loadImage(this.images[index])
                        ...
                        .then(function () {
                            ...
                            _this2.elems.description.textContent =
                                _this2.settings.description.call(_this2);
                            _this2.elems.pagination.textContent =
                                _this2.settings.pagination.call(_this2);
                        ...
                        .then(function () {
                            _this2.elems.container.classList.toggle(
                                "chocolat-zoomable",
                                _this2.zoomable(image, _this2.elems.wrapper)
                            );
            ...
            },
            {
                ...
                value: function destroy() {
                    ...
                    (_this$elems$container = this.elems.container.classList).remove.apply(
                        _this$elems$container,
                        _toConsumableArray(this._cssClasses)
                    );
            ...
            },
            {
                ...
                value: function attachListeners() {
                    ...
                    this.on(this.elems.imageWrapper, "click.chocolat", function (e) {
                        if (
                            _this6.state.initialZoomState === null &&
                            _this6.elems.container.classList.contains("chocolat-zoomable")
                        ) {
                            e.stopPropagation();
                    ...
                    this.on(window, "resize.chocolat", function (e) {
                        ...
                        debounce(50, function () {
                            ...
                            _this6.position(_this6.elems.img).then(function () {
                                _this6.elems.container.classList.toggle(
                                    "chocolat-zoomable",
                                    _this6.zoomable(_this6.elems.img, _this6.elems.wrapper)
                                );
                            });
                        });
                    });
